...
<svg xmlns="http://www.w3.org/2000/svg" width="700" height="420" viewBox="0 0 700 420" role="img" aria-label="RepoRack embed for ${esc(info.fullName)}">
  <defs>
  ...
  <text x="676" y="402" text-anchor="end" fill="${theme.textColor}" font-family="Geist, Inter, Segoe UI, Arial" font-size="12" opacity="0.82">Powered by reporack.dev</text>
</svg>`;
    ...
    return new NextResponse(
      `<?xml version="1.0" encoding="UTF-8"?><svg xmlns="http://www.w3.org/2000/svg" width="640" height="180"><rect width="100%" height="100%" fill="#111"/><text x="20" y="40" fill="#fff" font-family="Arial" font-size="18">RepoRack embed error</text><text x="20" y="70" fill="#aaa" font-family="Arial" font-size="14">${esc(
