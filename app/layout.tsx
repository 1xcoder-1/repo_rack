...
export const metadata: Metadata = {
  title: {
    default: "RepoRack — GitHub Star History Charts",
    template: "%s | RepoRack",
  },
  description:
  ...
  metadataBase: new URL("https://reporack.dev"),
  keywords: [
    "github stars",
    "star history",
    "github star chart",
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://reporack.dev",
    siteName: "RepoRack",
    title: "RepoRack — GitHub Star History Charts",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "RepoRack — GitHub Star History Charts with Themes",
      },
    ],
  },
  twitter: {
